     ...
     gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <div className="flex gap-3">
          ...
          <input class="border border-gray-300 rounded py-1.5 px-3.5 w-full"
            type="text" placeholder="Last name" value=""></input>
        </div>
        <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full'
        ...
        <div className="flex gap-3">
          ...
          <input class="border border-gray-300 rounded py-1.5 px-3.5 w-full"
            type="text" placeholder="State" value=""></input>
        </div>
        <div className="flex gap-3">
          <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full'
            type="number" placeholder='Zipcode' />
          <input class="border border-gray-300 rounded py-1.5 px-3.5 w-full"
            type="text" placeholder="Country" value=""></input>
        </div>
        <input class="border border-gray-300 rounded py-1.5 px-3.5 w-full"
          type="text" placeholder="Phone" value=""></input>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-10">
          ...
          <div className='w-full text-end'>
            <button onClick={() => navigate('/orders')} className='bg-black text-white mt-10 px-14 py-3 text-sm'>
              PLACE ORDER
            </button>
          </div>
        </div>
